                            ...
                            <?php if ($result->num_rows() > 0) { ?>
                                <?php foreach ($result->result() as $key => $row): ?> 
                                    <tr id="row_<?php echo $row->id; ?>">
                                        ...
                                        <td>
                                            <?php echo $this->layout->element('admin/element/_module_status', array('status' => $row->is_active, 'id' => $row->id, 'url' => "admin/portals/changestatus", 'permissionKey' => "portal-status"), true); ?>
                                        </td>
                                        <td>  
                                            <?php //echo $this->layout->element('admin/element/_module_action', array('id' => $row->id, 'editUrl' => "admin/portals/manage", 'deleteUrl' => 'admin/portals/delete', 'editPermissionKey' => 'portal-edit', 'deletePermissionKey' => 'portal-delete'), true); ?>
                                            <a class="label label-warning" href="<?php echo site_url("admin/leads/index/inbox/$row->id"); ?>">View Leads</a>
                                        </td>  
                                    </tr>
                                <?php endforeach; ?>
                            <?php } ?> 
...
<div class="modal fade" id="modal-manage">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('admin/portals/manage', array("id" => "manage-form", "method" => "post")); ?>
