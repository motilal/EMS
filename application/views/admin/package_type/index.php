                            ...
                            <?php if ($result->num_rows() > 0) { ?>
                                <?php foreach ($result->result() as $key => $row): ?> 
                                    <tr id="row_<?php echo $row->id; ?>">
                                        ...
                                        <td>
                                            <?php echo $this->layout->element('admin/element/_module_status', array('status' => $row->is_active, 'id' => $row->id, 'url' => "admin/package_types/changestatus", 'permissionKey' => "package_type-status"), true); ?>
                                        </td>
                                        <td>  
                                            <?php echo $this->layout->element('admin/element/_module_action', array('id' => $row->id, 'editUrl' => "admin/package_types/manage", 'deleteUrl' => 'admin/package_types/delete', 'editPermissionKey' => 'package_type-edit', 'deletePermissionKey' => 'package_type-delete'), true); ?>
                                        </td>  
                                    </tr>
                                <?php endforeach; ?>
                            <?php } ?> 
...
<div class="modal fade" id="modal-manage">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('admin/package_types/manage', array("id" => "manage-form", "method" => "post")); ?>
