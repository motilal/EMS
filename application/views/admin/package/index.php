                            ...
                            <?php if ($result->num_rows() > 0) { ?>
                                <?php foreach ($result->result() as $key => $row): ?> 
                                    <tr id="row_<?php echo $row->id; ?>">
                                        ...
                                        <td>  
                                            <?php echo $this->layout->element('admin/element/_module_action', array('id' => $row->id, 'editUrl' => "admin/packages/manage/$row->id", 'viewUrl' => "admin/packages/view/$row->id", 'deleteUrl' => 'admin/packages/delete', 'editPermissionKey' => 'package-edit', 'deletePermissionKey' => 'package-delete'), true); ?>
                                        </td>  
                                    </tr>
                                <?php endforeach; ?>
                            <?php } ?> 
