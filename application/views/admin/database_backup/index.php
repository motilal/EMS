            ...
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    <div class="btn-group" data-toggle="btn-toggle"> 
                        <a href="<?php echo site_url('admin/database_backups/create_db_backup'); ?>" class="btn btn-primary btn-sm add_new_item"><i class="fa fa-plus"></i> Create Database Backup </a>
                    </div>
                </div>
            </div>     
            <!-- /.box-header -->
                        ...
                        <?php if (!empty($backupFiles)) { ?>
                            <?php foreach ($backupFiles as $key => $row): ?>
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        <?php echo $this->layout->element('admin/element/_module_action', array('id' => $encfile, 'deleteUrl' => "admin/database_backups/delete", 'downloadUrl' => "admin/database_backups/download/$encfile"), true); ?>
                                    </td>  
                                </tr>
                            <?php endforeach; ?>
                        <?php } ?> 
