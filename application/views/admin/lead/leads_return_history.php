<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo site_url('admin/leads/leads_return_history/' . $portal_id); ?>">Lead Return History</a></li>
        <li class="pull-right"> 
            <?php if (is_allow_action('lead-return-add')) { ?>
                <div style="width: 100%;">
                    <div class="btn-group" data-toggle="btn-toggle">
                        <a href="<?php echo site_url('admin/leads/add_lead_return_request'); ?>" class="btn btn-primary btn-sm add_new_tab_item"><i class="fa fa-plus"></i> Add Lead Return Request</a>
                    </div>
                </div> 
            <?php } ?>
        </li>
