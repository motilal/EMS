<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div class="tab-pane <?php echo ($action == 'change-profile' || $action == "") ? 'active' : ''; ?>" id="chnage_profile">
            <div class="row">
                <div class="col-lg-6"> 
                    <?php echo form_open('settings/profile', array("id" => "change-profile-form", "method" => "post")); ?>
                    ...
                    <button type="reset" class="btn btn-default" onclick="window.location.href = '<?php echo site_url("dashboard"); ?>'">Cancel</button>
                    <?php echo form_close(); ?> 
                </div>
            </div>
            <!-- /.col-lg-6 (nested) -->  
        ...
        <div class="tab-pane <?php echo $action == 'change-password' ? 'active' : ''; ?>" id="change_password">
            <div class="row">
                <div class="col-lg-6"> 
                    <?php echo form_open('settings/profile', array("id" => "change-password-form", "method" => "post")); ?>
