...
/*
  ...
  |
 */
$config['base_url'] = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on" ? 'https://' . $_SERVER['SERVER_NAME'] . '/easymysearch' : 'http://' . $_SERVER['SERVER_NAME'] . '/easymysearch';
...
/*
  ...
  |
 */
$config['encryption_key'] = 'XsfEsdfjjfEfd244D';
