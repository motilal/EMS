...
class Email_templates extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout->view("email_template/index", $this->viewData);
    }
    ...
    public function view($id = null) {
        ...
        $this->viewData['breadcrumb'] = array('Email Templates Manager' => 'email_templates', 'View Detail' => '');
        $this->layout->view("email_template/view", $this->viewData);
    }
    ...
    public function manage($id = null) {
        ...
        $this->viewData['breadcrumb'] = array('Email Template Manager' => 'companies', $this->viewData['title'] => '');
        $this->viewData['ckeditor_asset'] = true;
        $this->layout->view("email_template/manage", $this->viewData);
    }
