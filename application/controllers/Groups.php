...
class Groups extends CI_Controller {
    ...
    public function index() {
        ...
        $this->viewData['breadcrumb'] = array('Group Manager' => 'groups', $this->viewData['title'] => '');
        $this->layout->view("group/index", $this->viewData);
    }
    ...
    public function manage() {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            if ($has_permission === TRUE) {
                ...
                $detail->statusButtons = $this->layout->element('element/_module_status', array('status' => $detail->is_active, 'id' => $detail->id, 'url' => "groups/changestatus", 'permissionKey' => "group-status"), true);
                $detail->actionButtons = $this->layout->element('element/_module_action', array('id' => $detail->id, 'editUrl' => 'groups/manage', 'deleteUrl' => 'groups/delete', 'editPermissionKey' => 'group-edit', 'deletePermissionKey' => 'group-delete'), true);
