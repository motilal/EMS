...
class Package_types extends CI_Controller {
    ...
    public function index() {
        ...
        $this->viewData['breadcrumb'] = array('PackageType Manager' => 'admin/package_types', $this->viewData['title'] => '');
        $this->layout->view("admin/package_type/index", $this->viewData);
    }
    ...
    public function manage() {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            if ($has_permission === TRUE) {
                ...
                $detail->statusButtons = $this->layout->element('admin/element/_module_status', array('status' => $detail->is_active, 'id' => $detail->id, 'url' => "admin/package_types/changestatus", 'permissionKey' => "package_type-status"), true);
                $detail->actionButtons = $this->layout->element('admin/element/_module_action', array('id' => $detail->id, 'editUrl' => 'admin/package_types/manage', 'deleteUrl' => 'admin/package_types/delete', 'editPermissionKey' => 'package_type-edit', 'deletePermissionKey' => 'package_type-delete'), true);
