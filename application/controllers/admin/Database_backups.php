...
class Database_backups extends CI_Controller {
    ...
    function index() {
        ...
        $this->viewData['breadcrumb'] = array('Database Backup' => 'admin/database_backup');
        $this->layout->view("admin/database_backup/index", $this->viewData);
    }
    ...
    function create_db_backup() {
        ...
        redirect('admin/database_backups');
    }
