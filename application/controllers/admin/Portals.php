...
class Portals extends CI_Controller {
    ...
    public function index() {
        ...
        $this->viewData['breadcrumb'] = array('Portal Manager' => 'admin/portals', $this->viewData['title'] => '');
        $this->layout->view("admin/portal/index", $this->viewData);
    }
    ...
    public function manage() {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            if ($has_permission === TRUE) {
                ...
                $detail->statusButtons = $this->layout->element('admin/element/_module_status', array('status' => $detail->is_active, 'id' => $detail->id, 'url' => "admin/portals/changestatus", 'permissionKey' => "portal-status"), true);
                $detail->actionButtons = $this->layout->element('admin/element/_module_action', array('id' => $detail->id, 'editUrl' => 'admin/portals/manage', 'deleteUrl' => 'admin/portals/delete', 'editPermissionKey' => 'portal-edit', 'deletePermissionKey' => 'portal-delete'), true);
