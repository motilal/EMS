...
class Services extends CI_Controller {
    ...
    public function index() {
        ...
        $this->viewData['breadcrumb'] = array('Sub Service Manager' => 'admin/services', $this->viewData['title'] => '');
        $this->viewData['servicetypes_options'] = $this->servicetype->servicetypes_options();
        $this->layout->view("admin/service/index", $this->viewData);
    }
    ...
    public function manage() {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            if ($has_permission === TRUE) {
                ...
                $detail->statusButtons = $this->layout->element('admin/element/_module_status', array('status' => $detail->is_active, 'id' => $detail->id, 'url' => "admin/services/changestatus", 'permissionKey' => "service-status"), true);
                $detail->actionButtons = $this->layout->element('admin/element/_module_action', array('id' => $detail->id, 'editUrl' => 'admin/services/manage', 'deleteUrl' => 'admin/services/delete', 'editPermissionKey' => 'service-edit', 'deletePermissionKey' => 'service-delete'), true);
