...
class Flash_messages extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout->view("flash_message/index", $this->viewData);
    }
    ...
    public function manage($id = null) {
        ...
        $this->viewData['breadcrumb'] = array('Flash Message Manager' => 'flash_messages', $this->viewData['title'] => '');
        $this->viewData['group_options'] = $this->flash_message->group_options();
        $this->layout->view("flash_message/manage", $this->viewData);
    }
